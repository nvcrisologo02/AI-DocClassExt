# Script de prueba para invocar la funcion con Nota Simple 1.4 usando un documento local
#
...
#
# Ejemplos:
#   .\test-ingest-notasimple1-4-from-path.ps1 -DocumentPath "C:\\temp\\docs\\ns01.pdf"
#   powershell -ExecutionPolicy Bypass -File .\test-ingest-notasimple1-4-from-path.ps1 -DocumentPath "C:\\temp\\docs\\nota-simple-14.pdf"
#
# Nota:
# - DocumentPath debe ser una ruta local absoluta.
# - expectedType permanece fijo en "nota.simple.1_4".

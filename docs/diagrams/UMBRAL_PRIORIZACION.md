...
```mermaid
<!-- Diagrama: priorización de umbrales para Clasificación, Extracción y EstadoCalidad -->
flowchart TD
  ...
  Eresolve --> Edec{ratioCompletitud ≥ umbralCompletitud<br/>AND confianzaCU ≥ umbralConfianza?}

...
| **EP6** | Observabilidad y pruebas | IN PROGRESS | 88% | 536 tests C# en verde (verificado 2026-05-04 en `DocumentIA.Tests.Unit`), customStatus y seguimiento de orquestacion activos. Completados T-1/T-2/T-3/T-4/T-5/T-6. Telemetría CU granular (`CU.LimiterWaitMs`, `CU.AnalysisMs`, `CU.Attempts`) implementada y emitida a App Insights (2026-05-28). Pendiente: extender pipeline a Admin/E2E/AssetResolver, dashboards App Insights (7.3.3), alertas productivas (7.3.4). |

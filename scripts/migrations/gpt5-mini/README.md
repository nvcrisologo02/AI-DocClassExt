...
| — | `07-align-gpt5-sets.sql` — **cualquier entorno, idempotente** (AB#100219, ejecutado en DEV/PRE/PRO el 2026-08-14): superconjunto de 05+06 — alta del juego gpt-5-mini canonico y de los alias `gpt-4o-mini`/`gpt-5-mini` si faltan, y normalizacion del timeout de `extraction.gpt5-mini` a 180 s. Deja los 3 entornos identicos en azure-openai; con backup previo | Ninguno: el set activo (gpt-4o-mini) no se toca |

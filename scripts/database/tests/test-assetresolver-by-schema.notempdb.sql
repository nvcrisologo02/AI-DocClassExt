/*  Variante del harness SIN CREATE/DROP DATABASE (entornos sin permiso CREATE DATABASE).
    ...
    produccion. Cubre casing camelCase y PascalCase (COALESCE) y refcat anidado en array.
    Exito = en Messages: OK: descubrimiento / aplicacion / idempotencia / rollback. */
SET NOCOUNT ON;
GO
...
IF EXISTS (SELECT 1 FROM #Tipologias

...
- **Enriquecimiento**: ConfiguracionJson contiene tipologiaNombre + gptdescripcion
- **Fallback**: Integrado en fallback chain tras DI y Foundry LLM
- **Documentación**: Ver ANEXO_PROVIDER_GPT_CLASIFICACION_DOS_FASES.md
...
| 04_MANUAL_EXPLOTACION.md | Instalacion, despliegue, operacion |
| [CONTRATO_API_HTTP.md](CONTRATO_API_HTTP.md) | Contrato de API REST detallado |
| [MANUAL_PLUGINS.md](../4_uso_y_configuracion/MANUAL_PLUGINS.md) | Guia de desarrollo de plugins |
| [ESPECIFICACION_CAPA_SERVICIO_GDC_SINTWS.md](ESPECIFICACION_CAPA_SERVICIO_GDC_SINTWS.md) | Integracion con GDC SINTWS |

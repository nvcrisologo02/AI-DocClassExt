...
**Referencia:** [docs/03_DISENO_TECNICO_DETALLADO.md - Gestionar Tipologias](../2_arquitectura_y_diseno/03_DISENO_TECNICO_DETALLADO.md)
...
**Referencia:** [docs/03_DISENO_TECNICO_DETALLADO.md - ClasificarActivity](../2_arquitectura_y_diseno/03_DISENO_TECNICO_DETALLADO.md)
...
**Referencia:** [docs/manuales/MANUAL_VALIDACIONES.md](../4_uso_y_configuracion/MANUAL_VALIDACIONES.md)
...
**Referencia:** [docs/especificaciones/ESPECIFICACION_PLUGIN_ASSETRESOLVER.md](../2_arquitectura_y_diseno/ESPECIFICACION_PLUGIN_ASSETRESOLVER.md)
...
### B.1 Sareb / dominio de negocio

| Acrónimo | Significado | Contexto |
|----------|-------------|---------|
| **SAREB** | Sociedad de Gestión de Activos procedentes de la Reestructuración Bancaria | Cliente y dominio de negocio |
| **GDC** | Gestor Documental Corporativo | Sistema documental externo de Sareb |
| **SINTWS** | Servicio web (SOAP) del GDC | Interfaz de integración con el GDC |
| **NS** | Nota Simple (Registral) | Tipología documental principal |
| **IDUFIR** | Identificador Único de Finca Registral | Identificador registral de la finca |
| **NIF** | Número de Identificación Fiscal | Identificador de persona/empresa |
| **TDN1 / TDN2** | Niveles de clasificación jerárquica del documento | Clasificación en una o dos fases |

### B.2 Azure / plataforma

| Acrónimo | Significado | Contexto |
|----------|-------------|---------|
| **DF** | Durable Functions | Orquestador del pipeline (Azure Functions) |
| **KV** | Key Vault | Almacén de secretos y credenciales |
| **MI** | Managed Identity | Identidad gestionada para acceso a recursos |
| **RBAC** | Role-Based Access Control | Control de acceso por roles en Azure |
| **RG** | Resource Group | Grupo de recursos (SRBRGDOCSAIPROD) |
| **KQL** | Kusto Query Language | Consultas en Application Insights |

### B.3 IA / Content Understanding

| Acrónimo | Significado | Contexto |
|----------|-------------|---------|
| **CU** | Azure Content Understanding | Proveedor de extracción/clasificación |
| **DI** | Azure Document Intelligence | Proveedor de extracción de layout/OCR |
| **GPT** | Generative Pre-trained Transformer | Modelo de Azure OpenAI (fallback de clasificación/extracción) |
| **LLM** | Large Language Model | Modelo de lenguaje (ruta GPT) |
| **OCR** | Optical Character Recognition | Reconocimiento de texto en el documento |

### B.4 Generales / técnicos

| Acrónimo | Significado | Contexto |
|----------|-------------|---------|
| **API** | Application Programming Interface | Contratos HTTP REST |
| **REST** | Representational State Transfer | Protocolo de comunicación |
| **SOAP** | Simple Object Access Protocol | Protocolo del GDC y plugins legacy |
| **JSON** | JavaScript Object Notation | Formato de configuración/datos |
| **SQL** | Structured Query Language | Base de datos SQL Server |
| **EF** | Entity Framework Core | ORM de .NET |
| **ORM** | Object-Relational Mapping | Abstracción de base de datos |
| **PDF** | Portable Document Format | Formato de entrada de documentos |
| **SHA256** | Secure Hash Algorithm 256-bit | Hash de deduplicación |
...
|-----------|----------|--------|
| **Diseño Técnico Detallado** | Arquitectura pipeline, diagrama flujo, actividades. | [03_DISENO_TECNICO_DETALLADO.md](../2_arquitectura_y_diseno/03_DISENO_TECNICO_DETALLADO.md) |
| **Análisis Funcional** | Casos de uso, actores, CU1-CU6. | [02_ANALISIS_FUNCIONAL.md](02_ANALISIS_FUNCIONAL.md) |
| **Manual Validaciones** | Especificación motor validación, 11 tipos. | [docs/manuales/MANUAL_VALIDACIONES.md](../4_uso_y_configuracion/MANUAL_VALIDACIONES.md) |
| **Manual Plugins** | Arquitectura plugins, integración REST/SOAP. | [docs/manuales/MANUAL_PLUGINS.md](../4_uso_y_configuracion/MANUAL_PLUGINS.md) |
| **Especificación AssetResolver** | Detalles búsqueda activos, criterios AND/OR. | [docs/especificaciones/ESPECIFICACION_PLUGIN_ASSETRESOLVER.md](../2_arquitectura_y_diseno/ESPECIFICACION_PLUGIN_ASSETRESOLVER.md) |
| **Fuente Verdad Configuración** | Autoridad canónica BD config. | [docs/referencias/FUENTE_VERDAD_CONFIGURACION.md](../4_uso_y_configuracion/FUENTE_VERDAD_CONFIGURACION.md) |
| **Plantilla Plugins JSON** | Formato config plugins. | [docs/contratos/PLANTILLA_PLUGINS_JSON.md](../2_arquitectura_y_diseno/PLANTILLA_PLUGINS_JSON.md) |
| **Checklists Despliegue** | Validación pre-prod + prod. | [docs/08_CHECKLISTS_DESPLIEGUE.md](../3_operacion_y_despliegue/08_CHECKLISTS_DESPLIEGUE.md) |
| **API Documentation v1.4** | Contratos REST endpoints. | [docs/15_API_DOCUMENTATION_V1_4.md](../2_arquitectura_y_diseno/15_API_DOCUMENTATION_V1_4.md) |

...
**Estado:** Verificado contra pipelines (azure-pipelines.yml, azure-pipelines-functions.yml, azure-pipelines-admin.yml)  
**Fecha de fotografía de infraestructura:** 2026-06-30  
...
│   ├── Migrations: EF Core 8 packages; applied manually/on-demand (dotnet-ef CLI 9.x)
...
| **CU MaxConcurrentCalls** | 4 (pipeline var, not in host.json) |
...
2. Deploy to srbappprodocai using zipDeploy
...
- GDC endpoint has SSL bypass (legacy system workaround)
...
- [DATA_MODELS_ER_DIAGRAM.md](../2_arquitectura_y_diseno/DATA_MODELS_ER_DIAGRAM.md) — Database schema
- [EXTENSIBILIDAD_PLUGIN_SYSTEM.md](../2_arquitectura_y_diseno/EXTENSIBILIDAD_PLUGIN_SYSTEM.md) — Provider architecture
- [PERFORMANCE_TUNING.md](PERFORMANCE_TUNING.md) — Concurrency & timeout tuning
- [INDEX.md](../00_INDICE.md) — Master documentation index

---

**Estado:** Verificado contra las definiciones de pipeline (azure-pipelines.yml).

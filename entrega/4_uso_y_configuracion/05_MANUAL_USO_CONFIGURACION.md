...
# Importante: El llamador es responsable del coste adicional. Se registra traza de auditoría.
$body = @{
  instrucciones = @{
...
Ver contrato funcional de precedencia en [ESPECIFICACION_PLUGIN_ASSETRESOLVER.md](../2_arquitectura_y_diseno/ESPECIFICACION_PLUGIN_ASSETRESOLVER.md#13-contrato-funcional-de-precedencia-de-criterios-y-propagacion-de-idactivo).
...
```json
{
  ...
  "AssetResolver:ApiKey": "<ASSET_RESOLVER_API_KEY>"
}
```
...
| Documento | Contenido |
|-----------|-----------|
| [03_DISENO_TECNICO_DETALLADO.md](../2_arquitectura_y_diseno/03_DISENO_TECNICO_DETALLADO.md) | Contratos API completos con JSON de ejemplo |
| 04_MANUAL_EXPLOTACION.md | Instalacion, despliegue, variables de entorno |
| [CONTRATO_API_HTTP.md](../2_arquitectura_y_diseno/CONTRATO_API_HTTP.md) | Contrato API original detallado |
| [CONFIANZA_AGREGADA.md](../2_arquitectura_y_diseno/CONFIANZA_AGREGADA.md) | Logica de calculo de confianza |

...
namespace DocumentIA.Data.Migrations
{
    ...
    [Migration("20260513141533_AddHybridTdnFields")]
    partial class AddHybridTdnFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DocumentIA.Data.Entities.TipologiaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Codigo = "tasacion",
                            Estado = 1,
                            FechaCreacion = new DateTime(2026, 5, 13, 14, 15, 33, 118, DateTimeKind.Utc).AddTicks(2199),
                            Nombre = "Tasación",
                            PublicadaEn = new DateTime(2026, 5, 13, 14, 15, 33, 118, DateTimeKind.Utc).AddTicks(2195),
                            PublicadaPor = "seed",
